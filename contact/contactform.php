...
$formproc->AddRecipient('lynbor@gmail.com'); //<<---Put your email address here
...
<div class='container'>
    ...
    <input type='text' name='phone' id='phone' value='<?php echo htmlentities($_POST['phone']) ?>' maxlength="15" /><br/>
...
<a href='http://www.html-form-guide.com/contact-form/creating-a-contact-form.html'
>how to make a contact form</a></div></noscript>
<!--
Form Code End
